...
<!--  <div class="container py-5">
    <div class="row g-5">
      ...
      <div class="col-lg-3 col-md-6">
        ...
        <a class="btn btn-link" href="">About Us</a> <a class="btn btn-link" href="">Contact Us</a> <a class="btn btn-link" href="">Our Services</a> <a class="btn btn-link" href="">Terms & Condition</a> <a class="btn btn-link" href="https://help.desagarut.id">Support</a> </div>
      <div class="col-lg-3 col-md-6">
        <h5 class="text-light mb-4">Gallery</h5>
        <div class="row g-2">
          <div class="col-4"> <img class="img-fluid rounded" src="<?= base_url("$this->theme_folder/$this->theme/img/project-1.jpg") ?>" alt="Image"> </div>
          <div class="col-4"> <img class="img-fluid rounded" src="<?= base_url("$this->theme_folder/$this->theme/img/project-2.jpg") ?>" alt="Image"> </div>
          <div class="col-4"> <img class="img-fluid rounded" src="<?= base_url("$this->theme_folder/$this->theme/img/project-3.jpg") ?>" alt="Image"> </div>
          <div class="col-4"> <img class="img-fluid rounded" src="<?= base_url("$this->theme_folder/$this->theme/img/project-4.jpg") ?>" alt="Image"> </div>
          <div class="col-4"> <img class="img-fluid rounded" src="<?= base_url("$this->theme_folder/$this->theme/img/project-5.jpg") ?>" alt="Image"> </div>
          <div class="col-4"> <img class="img-fluid rounded" src="<?= base_url("$this->theme_folder/$this->theme/img/project-6.jpg") ?>" alt="Image"> </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6">

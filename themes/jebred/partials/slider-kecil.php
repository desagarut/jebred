<?php if (!defined('BASEPATH')) exit('No direct script access allowed');?>
    ...
    <!-- Slider Kecil Start -->
    <div class="container py-4"  style="background-color:#333">
        <div class="container">
            ...
            <?php if(is_file($file_gambar)) : ?>
                <div class="testimonial-item bg-light rounded p-1" style="background-image: url(<?php echo base_url().$slider_gambar['lokasi'].'sedang_'.$gambar['gambar']?>); background-size: cover; background-position: center; background-repeat: no-repeat; height: 200px; position: relative;
">

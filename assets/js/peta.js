...
function set_marker_desa(marker_kecamatan, kecamatan, judul, favico_desa)
{
  ...
  if (desa['lng'])
  {
    marker_kecamatan.push(turf.point([desa['lng'], desa['lat']], {content: desa, style: L.icon(point_style)}));
  }
  marker_kecamatan.push(turf.polygon(daerah_desa, {content: desa, style: style_polygon}));
}

function set_marker_desa_content(marker_kecamatan, desa, judul, favico_desa, contents)
{
	var daerah_desa = JSON.parse(desa['path']);
  var jml = daerah_desa[0].length;
  daerah_desa[0].push(daerah_desa[0][0]);
  ...
  if (desa['lng'])
  {
    marker_kecamatan.push(turf.point([desa['lng'], desa['lat']], {name: "kantor_kecamatan", content: "Kantor Kecamatan", style: L.icon(point_style)}));
  }
  marker_kecamatan.push(turf.polygon(daerah_desa, {content: content, style: style_polygon}));
}
...
function poligonWil(marker)
{
    ...
    onEachFeature: function (feature, layer) {
    	if (feature.properties.name == 'kantor_kecamatan')
    	{
    		// Beri classname berbeda, supaya bisa gunakan css berbeda
	      layer.bindPopup(feature.properties.content, {'className' : 'kantor_kecamatan'});
    	}
    	else
    	{
...
function overlayWil(marker_kecamatan, marker_dusun, marker_rw, marker_rt, sebutan_desa, sebutan_dusun)
{
  var poligon_wil_desa = poligonWil(marker_kecamatan);
  ...
  var overlayLayers = {
    'Peta Wilayah Kecamatan': poligon_wil_desa,
    'Peta Wilayah Desa': poligon_wil_dusun,
    'Peta Wilayah Dusun': poligon_wil_rw,
    'Peta Wilayah RW': poligon_wil_rt
  };

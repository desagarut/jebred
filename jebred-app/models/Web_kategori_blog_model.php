...
class Web_kategori_blog_model extends CI_Model {
	...
	{
		$sql = " FROM kategori_blog k WHERE parrent = 0";
		$sql .= $this->search_sql();
		$sql .= $this->filter_sql();
		return $sql;
	}
	...
	public function list_data($o=0, $offset=0, $limit=500)
	{
		...
		$sql = "SELECT k.*, k.kategori_blog AS kategori " . $this->list_data_sql();
		$sql .= $order_sql;
		$sql .= $paging_sql;
	...
	{
		$sql = "SELECT * FROM kategori_blog WHERE parrent = ? ORDER BY urut";
	...
	public function list_link()
	{
		$sql = "SELECT a.*
			FROM artikel a
			INNER JOIN kategori_blog k ON a.id_kategori = k.id
			WHERE tipe = '2'";
	...
	public function list_kategori_blog($o = "")
	{

...
class User_model extends CI_Model {
	...
	public function hak_akses($group, $controller, $akses)
	{
		...
		$hak_akses = array(
			...
			50 => array(
				...
				//Perencanaan Desa
				'partisipasi_tingkat_desa' => array('b','u','h'),
				'partisipasi_tingkat_desa_polling' => array('b','u','h'),
				//Perencanaan Kecamatan
				'partisipasi_tingkat_kecamatan' => array('b','u','h'),
				'partisipasi_tingkat_kecamatan_polling' => array('b','u','h'),
			),
  ...
  // Key disimpan di $this->session->fm_key yg dipasang di setting tinymce
	// dan di tempat memanggil filemanager, seperti di jebred-app/views/setting/setting_qr.php.

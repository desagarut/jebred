			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item "><a href="<?= site_url('gallery') ?>"><i class="fa fa-dashboard"></i> Daftar Album</a></li>
						<li><a href='<?= site_url("gallery/sub_gallery/$album") ?>'><i class="fa fa-dashboard"></i> Daftar Gambar Album</a></li>
						<li class="breadcrumb-item active">Pengaturan Gambar Album</li>
					</ol>
				</div>
				<!-- /.col -->
			</div>

																				...
																				<td style="padding-top:20px;padding-bottom:10px;">
																					<div class="form-group">
																						...
																						<div class="col-sm-12 col-md-3 col-lg-2">
																							<a href="#" form="kosongkan" class="btn btn-box btn-block btn-danger btn-sm"  title="Kosongkan DB" data-toggle="modal" data-target="#confirmsubmit"><i class="fa fa-trash"></i> Kosongkan DB</a>
																						</div>

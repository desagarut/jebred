																		...
																		<td class="aksi">
																			<?php if ($data['boleh_ubah']) : ?>
																				<?php if ($this->CI->cek_hak_akses('u')) : ?>
																					...
																					<a href="#" data-href="<?= site_url("web_blog/delete/$data[id]") ?>" class="btn bg-maroon btn-box btn-sm" title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i></a>
																				...
																				<?php if ($data['boleh_komentar'] == 1) : ?>
																					<a href="<?= site_url("web_blog/komentar_lock/$data[id]/2") ?>" class="btn bg-info btn-box btn-sm" title="Tutup Komentar Artikel"><i class="fa fa-comment-o"></i></a>
																				<?php else : ?>
																					<a href="<?= site_url("web_blog/komentar_lock/$data[id]/1") ?>" class="btn bg-info btn-box btn-sm" title="Buka Komentar Artikel"><i class="fa fa-comment"></i></a>
																				<?php endif ?>
																				<?php if ($data['enabled'] == '1') : ?>
																					<a href="<?= site_url("web_blog/artikel_lock/$data[id]/2"); ?>" class="btn bg-navy btn-box btn-sm" title="Non Aktifkan Artikel"><i class="fa fa-unlock"></i></a>

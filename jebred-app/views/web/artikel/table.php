                                      ...
                                      <tr>
                                        ...
                                        <td nowrap><?php if ($data['boleh_ubah']) : ?>
                                            ...
                                            <?php if ($data['enabled'] == '1') : ?>
                                              ...
                                              <a href="<?= site_url("web/headline/$data[id]") ?>" class="btn bg-teal btn-box btn-sm" title="Jadikan Headline"> <i class="<?= ($data['headline'] == 1) ? 'fa fa-star-o' : 'fa fa-star' ?>"></i> </a> 
                                              <a href="<?= site_url("web/slide/$data[id]"); ?>" class="btn bg-gray btn-box btn-sm" title="<?= ($data['headline'] == 3) ? 'Keluarkan dari slide' : 'Masukkan ke dalam slide' ?>"> <i class="<?= ($data['headline'] == 3) ? 'fa fa-pause' : 'fa fa-play' ?>"></i> </a>
                                            <?php else : ?>

	...
	<div class="page-header">
		...
		<ul class="breadcrumb">
			...
			<li><a href="<?= site_url('web_widget')?>"> Daftar Widget</a></li>
						<li class="breadcrumb-item active">Pengaturan Widget</li>
					</ol>
				</div>
				<!-- /.col -->
			</div>
						...
						<div class="card-body">
							...
							<div id="statis" class="form-group" <?php !$statis and print('style="display:none;"') ?>>
								...
								<div class="col-sm-6">
									...
									<?php else:?>
										<span class="help-block"><code>Widget tidak tersedia atau sudah ditambahkan semua (instansi/widgets atau instansi/themes/nama_tema/widgets)</code></span>
									<?php endif;?>
									</div>
								</div>
							</div>

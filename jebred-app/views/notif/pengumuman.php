		...
		<div class='modal-dialog'>
			<div class='modal-content'>
				...
				<div class='modal-footer' id='m_footer'>
					<?php if ($jenis == 'pengumuman'): ?>
						<button type="reset" data-dismiss="modal" id="btnSetuju" class="btn btn-box btn-warning btn-sm"><i class='fa fa-sign-out'></i> OK</button>
					<?php else: ?>
						<button type="reset" data-dismiss="modal" id="btnTidak" class="btn btn-box btn-danger btn-sm"><i class='fa fa-sign-out'></i> Tidak</button>
						<button  type="submit" id="btnSetuju" class="btn btn-box btn-warning btn-sm"><i class='fa fa-check'></i> Setuju</button>
					<?php endif; ?>
				</div>
			</div>
		</div>

                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="card-body">
                            <a href="https://kecamatancisompet.id" target="_blank" class="btn btn-block btn-social btn-info">
                                <span class="info-box-icon bg-clear"><img src="<?= logo_web($desa['logo']);?>" class="img-circle" alt="Website GarutKab.Go.ID" width="70px"></span> DASH. KECAMATAN</a>
                        </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="card-body">
                        <a href="https://garutkab.go.id" target="_blank" class="btn btn-block btn-social btn-info">
                            <span class="info-box-icon bg-clear"><img src="<?= logo_web($desa['logo']);?>" class="img-circle" alt="Website GarutKab.Go.ID" width="70px"></span> PEMKAB GARUT</a>
                    </div>
                </div>
